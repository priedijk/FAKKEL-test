...
variable "environment" {
  description = "Specifies the environment to which the Storage account belongs, as part of naming convention pattern `st<application><env><name_suffix>`. Possible values as are: `prd`, `fve`, `vte`, `tre`, `npe`, `acp`, `cae`, `ite`, `dev`, `ete`."
  type        = string
  validation {
