...
variable "fileshare_soft_delete_retention_days" {
  description = "Specifies the number of days that the file share should be retained, between 1 and 365 days. Defaults to 7"
  default     = 7
}

variable "is_fileshare_soft_delete_enabled" {
  description = "Is File Share delete retention policy is enabled?"
  type        = string
  default     = "yes"
}
